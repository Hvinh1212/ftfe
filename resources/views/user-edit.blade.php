        ...
        <div class="row flex-nowrap">
            ...
            <div class="col py-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="editUserForm" method="post" action="{{ route('user.update', $user) }}">
                            @method('PUT')
                            @csrf
                            <div class="space-y">
                                <div class="row row-cols-2 g-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="user_flg" id="user_flg"
                                            ...
                                            <option value="0" @selected($user->user_flg === 0)>Admin (0)</option>
                                            <option value="1" @selected($user->user_flg === 1)>User (1)</option>
                                            <option value="2" @selected($user->user_flg === 2)>Support (2)</option>
                                        </select>
                                        @error('user_flg')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row row-cols-2 g-4 mt-1">
                                    <div>
                                        ...
                                        <input type="text" name="date_of_birth" id="datePicker"
                                            value="{{ $user->date_of_birth?->format('Y/m/d') }}" class="form-control @error('date_of_birth') is-invalid @enderror"
